...
public class ViewStoreController {
    ...
    void btnViewCartPressed(ActionEvent event) {
        try {
            final String FXML_CART_PATH = "hust/soict/ict/aims/screen/customer/view/Store.fxml";
    ...
    public void initialize() {
        final String FXML_ITEM_PATH = "hust/soict/ict/aims/screen/customer/view/Store.fxml";
        int column = 0;
        int row = 1;
