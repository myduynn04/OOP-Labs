...
public class Store {
    ...
    public void initData() {
        // Khởi tạo 10 sách
        addMedia(new Book(1, "Java Programming", "Education", "John Smith", 25.0, 123));
        addMedia(new Book(2, "Python Basics", "Education", "Alice Johnson", 20.0, 124));
        addMedia(new Book(3, "Data Structures", "Education", "David Lee", 30.0, 125));
        addMedia(new Book(4, "Algorithms", "Education", "Emily Wang", 28.0, 126));
        addMedia(new Book(5, "Machine Learning", "Education", "Michael Brown", 35.0, 127));
        addMedia(new Book(6, "History of Art", "History", "Sophia Davis", 18.0, 128));
        addMedia(new Book(7, "World War II", "History", "William Wilson", 22.0, 129));
        addMedia(new Book(8, "Ancient Civilizations", "History", "Olivia Martinez", 26.0, 130));
        addMedia(new Book(9, "Literature Classics", "Literature", "Ethan Taylor", 32.0, 131));
        addMedia(new Book(10, "Modern Poetry", "Literature", "Ava Anderson", 15.0, 132));
        ...
        CompactDisc cd5 = new CompactDisc("Album E", "Classical", "Singer E", "Band E", 75, 18.0);
